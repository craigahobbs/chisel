...
"""
    ...
    def test_doc_createIndexHtml(self):
        ...
        self.assertTrue(html.find('<li><a href="/myAction1">myAction1</a></li>') != -1)
        self.assertTrue(html.find('<li><a href="/myAction2">myAction2</a></li>') != -1)
        self.assertTrue(html.find('<style type="text/css">') != -1)
        ...
        self.assertTrue(html.find('<li><a href="/myAction1">myAction1</a></li>') != -1)
        self.assertTrue(html.find('<li><a href="/myAction2">myAction2</a></li>') != -1)
        self.assertTrue(html.find('<link href="/mystyle.css" rel="stylesheet" type="text/css">') != -1)
    ...
    def test_doc_createActionHtml(self):
        ...
        HTMLValidator.validate(html)
        self.assertTrue(html.find('<h1>myAction1</h1>') != -1)
        self.assertTrue(html.find('<h2 id="myAction1_Input"><a class="linktarget">Input Parameters</a></h2>') != -1)
        self.assertTrue(html.find('The action has no input parameters.') == -1)
        self.assertTrue(html.find('<h2 id="myAction1_Output"><a class="linktarget">Output Parameters</a></h2>') != -1)
        self.assertTrue(html.find('The action has no output parameters.') != -1)
        self.assertTrue(html.find('<h2 id="myAction1_Error"><a class="linktarget">Error Codes</a></h2>') != -1)
        self.assertTrue(html.find('The action returns no custom error codes.') != -1)
        self.assertTrue(html.find('<h2>User Types</h2>') != -1)
        self.assertTrue(html.find('<style type="text/css">') != -1)

        # Validate the myAction2's HTML
        html = createActionHtml("/", specParser.model.actions["myAction2"])
        HTMLValidator.validate(html)
        self.assertTrue(html.find('<h1>myAction2</h1>') != -1)
        self.assertTrue(html.find('<h2 id="myAction2_Input"><a class="linktarget">Input Parameters</a></h2>') != -1)
        self.assertTrue(html.find('The action has no input parameters.') != -1)
        self.assertTrue(html.find('<h2 id="myAction2_Output"><a class="linktarget">Output Parameters</a></h2>') != -1)
        self.assertTrue(html.find('The action has no output parameters.') == -1)
        self.assertTrue(html.find('<h2 id="myAction2_Error"><a class="linktarget">Error Codes</a></h2>') != -1)
        self.assertTrue(html.find('The action returns no custom error codes.') == -1)
        self.assertTrue(html.find('<h2>User Types</h2>') != -1)
        self.assertTrue(html.find('<style type="text/css">') != -1)
